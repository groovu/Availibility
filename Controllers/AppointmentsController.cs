...
namespace Availibility.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public AppointmentsController(AvailibilityContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Time,Location,Notes")] Appointment appointment)
        {
